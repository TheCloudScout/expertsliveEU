<#
    ...
    V0.9 by Koos Goossens - last update: November 11th 2022
...
$subscriptionId = "6c74142b-dfde-46b7-accf-b097b85fe8b0"
...
foreach ($workspace in $workspaces) {
    ...
    # Compare Current Sku' with optimal Sku
    Write-Host "  ┖─ Checking if Sku needs changing..." -ForegroundColor Gray
...
Write-Host "┗━━━" -ForegroundColor Green
$sentinelWorkspaces | Select-Object -Last 20 | Format-Table workspaceName, SubscriptionName, sentinelEnabled, retentionInDays, averageDailyIngest, currentSku, optimalSku, billedRetentionGB
